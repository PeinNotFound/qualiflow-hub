import {
  ...
  Newspaper, Calendar, Lock, HeartHandshake
} from "lucide-react";
...
export const modules: ModuleDef[] = [
  ...
  { slug: "audits", title: "Audits", short: "Audits internes", description: "Planification, suivi et rapports automatiques", icon: ClipboardCheck, group: "processus", iso: "9.2" },
  ...
  { slug: "indicateurs", title: "Indicateurs (KPI)", short: "Pilotage", description: "Tableaux de bord temps réel et suivi de performance", icon: Activity, group: "processus", iso: "9.1" },
  ...
  { slug: "fournisseurs", title: "Fournisseurs", short: "Achats", description: "Évaluation, sélection et veille des contrats", icon: Truck, group: "processus", iso: "8.4" },
